...
fastavro.write.LOGICAL_WRITERS["string-vol_coll_id"] = idValueMatch
fastavro.read.LOGICAL_READERS["string-vol_coll_id"] = decode

fastavro.write.LOGICAL_WRITERS["string-system_name"] = idValueMatch
fastavro.read.LOGICAL_READERS["string-system_name"] = decode
...
fastavro.write.LOGICAL_WRITERS["string-prov_type"] = idValueMatch
fastavro.read.LOGICAL_READERS["string-prov_type"] = decode

fastavro.write.LOGICAL_WRITERS["boolean-active"] = idValueMatch
fastavro.read.LOGICAL_READERS["boolean-active"] = decode

fastavro.write.LOGICAL_WRITERS["boolean-is_connected"] = idValueMatch
fastavro.read.LOGICAL_READERS["boolean-is_connected"] = decode

fastavro.write.LOGICAL_WRITERS["boolean-is_replicated"] = idValueMatch
fastavro.read.LOGICAL_READERS["boolean-is_replicated"] = decode

fastavro.write.LOGICAL_WRITERS["boolean-has_multiple_replication_partners"] = idValueMatch
fastavro.read.LOGICAL_READERS["boolean-has_multiple_replication_partners"] = decode

fastavro.write.LOGICAL_WRITERS["string-app_id"] = idValueMatch
fastavro.read.LOGICAL_READERS["string-app_id"] = decode

fastavro.write.LOGICAL_WRITERS["string-app_name"] = idValueMatch
fastavro.read.LOGICAL_READERS["string-app_name"] = decode
...
fastavro.write.LOGICAL_WRITERS["long-creation_time"] = idValueMatch
fastavro.read.LOGICAL_READERS["long-creation_time"] = decode
